    ...
    <div class="flex flex-row items-center justify-center -my-2">
      ...
      <div class="flex flex-row flex-1">
        ...
        <div class="flex flex-row items-center">
          <el-icon class="mr-1" size="16" @click="opendialog"><Edit /></el-icon>
          <el-icon size="16" @click="handleDeleteChat"><Delete /></el-icon>
        </div>
        <el-dialog class="px-8" v-model="changeTitleDialogVisiable" center>
          ...
          />
          <template #footer>
            <el-button class="mx-2" @click="changeTitleDialogVisiable = false"
              >取消</el-button
            >
            <el-button class="mx-2" type="primary" @click="closedialog"
              >确定</el-button
            >
          </template>
        </el-dialog>
        <el-dialog
          width="300"
          class="px-8"
          v-model="deleteChatDialogVisiable"
          center
        >
          <p class="flex justify-center text-lg">是否删除该对话？</p>
          <p class="flex justify-center mt-4">您将无法恢复对话的内容！</p>
          <template #footer>
            <el-button class="mx-2" @click="deleteChatDialogVisiable = false"
              >取消</el-button
            >
            <el-button class="mx-2" type="danger" @click="deleteChat"
              >确定</el-button
            >
          </template>
        </el-dialog>
